window.onload = function() {
  ...
  var gSharp0 = paper.path('M 389 291, L 382 349, L 398 349, L 405 291, L 389 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  ...
  var aSharp0 = paper.path('M 420 291, L 414 349, L 431 349, L 436 291, L 420 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  ...
  var cSharp1 = paper.path('M 468 291, L 465 349, L 483 349, L 485 291, L 468 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  ...
  var dSharp1 = paper.path('M 502 291, L 501 349, L 518 349, L 518 291, L 502 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  ...
  var f1 = paper.path('M 535 291, L 536 392, L 564 392, L 563.5 349, L 551 349, L 549 291, L 535 291, Z').attr({ fill: '#fff', stroke: '#000', strokeWidth: 0.5 });
  var fSharp1 = paper.path('M 550 291, L 552 348, L 567 348, L 565 291, L 550 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });

  var g1 = paper.path('M 566 291, L 568 349, L 564.5 349, L 566 392, L 595 392, L 593.5 349, L 583 349, L 580 291, L 566 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var gSharp1 = paper.path('M 581 291, L 584 348, L 600 348, L 596 291, L 581 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var a1 = paper.path('M 597 291, L 601 349, L 595 349, L 597 392, L 625.5 392, L 621 349, L 617 349, L 611 291, L 597 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var aSharp1 = paper.path('M 612 291, L 618 348, L 634 348, L 627 291, L 612 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var b1 = paper.path('M 628 291, L 635 349, L 623 349, L 627 392, L 656 392, L 643 291, L 630 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var c2 = paper.path('M 644 291, L 657 392, L 686 392, L 680 349, L 669 349, L 660 291, L 644 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var cSharp2 = paper.path('M 661 291, L 670 348, L 685 348, L 676 291, L 661 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var d2 = paper.path('M 677 291, L 686 349, L 681 349, L 687 392, 716 392, L 709 349, L 704 349, L 692 291, L 677 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var dSharp2 = paper.path('M 693 291, L 704.5 348, L 720 348, L 709 291, L 693 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var e2 = paper.path('M 710 291, L 721 349, L 710 349, L 717 392, L 746.5 392, 724 291, L 710 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var f2 = paper.path('M 726 291, L 748 392, L 777 392, L 767 349, 754 349, L 740 291, L 726 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var fSharp2 = paper.path('M 741 291, L 755 348, L 770 348, L 767.5 330, L 756 291, L 741 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });

  var g2 = paper.path('M 757 291, L 768.5 330, L 771 349, L 768 349, L 778 392, L 806 392, L 795 349, L 787 349, L 770 291, L 757 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var gSharp2 = paper.path('M 771 291, L 788 348, L 803 348, L 799 330, L 787 291, L 771 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var a2 = paper.path('M 788 291, L 800 330, L 804 348, L 796 348, L 808 392, L 825 392, L 836 392, L 824 347, L 819 347, L 801 291, L 788 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var aSharp2 = paper.path('M 802 291, L 820 346, L 835 346, L 833.5 328, L 819 291, L 802 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var b2 = paper.path('M 820 291, L 834.5 328, L 836 347, L 825 347, L 838 392, L 866 392, L 833 291, L 821 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var c3 = paper.path('M 834 291, L 867.5 392, L 894 392, L 880 348, L 869 348, L 848 291, 834 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var cSharp3 = paper.path('M 849 291, L 869.5 347, L 884 347, L 882 330, L 866 291, L 849 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var d3 = paper.path('M 867 291, L 883 330, L 885 348, L 881 348, L 895 392, L 923 392, L 909 348.5, L 902 348.5, L 880 291, L 867 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var dSharp3 = paper.path('M 881 291, L 903 347.5, L 918.5 347.5, L 914 330, L 897 291, L 881 291, Z').attr({ fill: "none", stroke: '#f00', strokeWidth: 0.5 });
  var e3 = paper.path('M 898 291, L 915 330, L 920 348.5, L 910 348.5, L 925 392, L 953 392, L 912 291, L 898 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
  var f3 = paper.path('M 913 291, L 954 392, L 982 392, L 937 291, L 913 291, Z').attr({ fill: 'none', stroke: '#f00', strokeWidth: 0.5 });
